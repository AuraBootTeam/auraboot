...
const qdpReleaseCenterSpecNames = [
  'qdp-release-center.golden',
  'core-workbenches.golden',
];
...
export default defineConfig({
  ...
  outputDir:
    process.env.CRM_BROWSER_ARTIFACT_DIR
    || process.env.QDP_BROWSER_ARTIFACT_DIR
    || '/tmp/crm-browser-artifacts',
  fullyParallel: false,
  workers: 1,
  retries: 0,
  timeout: 120_000,
