...
- 2026-06-23 final run expanded the audited set to all current `tests/e2e/saved-view/*.spec.ts` files except API-only record-comment/formula rows. Result was `101 passed / 4 skipped`; this does not change the scope boundary above.
