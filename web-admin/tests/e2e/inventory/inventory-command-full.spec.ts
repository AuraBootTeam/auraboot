...
const INVENTORY_COMMANDS = [
  ...
  'inv:delete_warehouse',
  'inv:create_warehouse_location',
  'inv:update_warehouse_location',
  'inv:delete_warehouse_location',
  'inv:create_warehouse_in',
  'inv:update_warehouse_in',
  'inv:delete_warehouse_in',
  'inv:confirm_warehouse_in',
  'pe:add_wh_in_line',
  'pe:delete_wh_in_line',
  'inv:create_warehouse_out',
  'inv:update_warehouse_out',
  'inv:delete_warehouse_out',
  'inv:confirm_warehouse_out',
  'pe:add_wh_out_line',
...
test.describe('Inventory Command Full Coverage', () => {
  ...
  test('INV-CMD-002: commands are bound to correct inv_ models', async ({ page }) => {
    const modelCommandMap: Record<string, string[]> = {
      inv_warehouse: ['inv:create_warehouse', 'inv:update_warehouse', 'inv:delete_warehouse'],
      inv_inbound: [
        'inv:create_warehouse_in',
        'inv:update_warehouse_in',
        'inv:delete_warehouse_in',
