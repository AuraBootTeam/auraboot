  ...
  const created = await seedQuoteScaffold(page, 'PFR', [
    {
      ...
      sourceRowNo: 2,
      description: 'Recognized package without a process-point rule',
      refdes: 'U9',
    ...
    },
    {
      ...
      sourceRowNo: 3,
      description: 'Unsupported package fact requiring manual review',
      refdes: 'U10,J10',
    ...
    {
      sourceRef: 'BOM-PFR-EXACT',
      sourceRowNo: 14,
      description: 'Exact 0201 package process-point fixture',
      refdes: 'R14',
      mpn: `E2E-EXACT-${suffix}`,
      packageName: '0201',
      qty: 4,
      unitCost: 0.25,
      lineCost: 1,
