...
export function ApprovalOpinionSection({
  ...
  return (
    ...
    >
      ...
      {/* Decision dropdown */}
      <div>
        <label htmlFor="approval-decision" className="mb-1 block text-sm font-medium text-gray-600">
          {/* TODO: i18n */}
          Decision
        </label>
        <select
          ...
          disabled={disabled}
          className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:border-transparent focus:ring-2 focus:ring-blue-500 focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-400"
      ...
      {/* Comment textarea */}
      <div>
        <label htmlFor="approval-comment" className="mb-1 block text-sm font-medium text-gray-600">
          {/* TODO: i18n */}
          Comment
        </label>
        <textarea
          ...
          rows={3}
          className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-transparent focus:ring-2 focus:ring-blue-500 focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-400"
