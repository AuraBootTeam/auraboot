...
import { useCanvasBlocks } from '~/studio/hooks/canvas/useCanvasBlocks';
import { useCanvasDnd } from '~/studio/hooks/canvas/useCanvasDnd';
...
export const CanvasEditor: React.FC<CanvasEditorProps> = ({
  ...
  const handleBlockUpdate = useCallback(
    (patch: Partial<import('~/studio/domain/canvas/types').CanvasBlock>) => {
      if (selectedBlockId) {
