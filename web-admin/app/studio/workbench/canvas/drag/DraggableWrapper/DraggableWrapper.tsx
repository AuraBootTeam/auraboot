...
import { useDraggableWrapper } from '~/studio/workbench/canvas/drag/DraggableWrapper/useDraggableWrapper';
import type { DraggableWrapperProps } from '~/studio/workbench/canvas/drag/DraggableWrapper/types';
