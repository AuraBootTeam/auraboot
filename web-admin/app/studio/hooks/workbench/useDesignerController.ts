...
import type { FormSchema, Component, Position } from '~/studio/domain/schema/types';
import { useDesignerStore, getDesignerSDK } from '~/studio/sdk';
...
import type { DesignerWorkflowProps } from '~/studio/workbench/components/DesignerWorkflow';
import { createDefaultSchema } from '~/studio/workbench/utils/schemaUtils';
