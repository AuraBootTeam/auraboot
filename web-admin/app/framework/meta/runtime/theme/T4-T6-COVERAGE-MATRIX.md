...
| blocks: detail-section / tabs / sub-table(带合计) / embedded-list / activity-timeline / field-history / record-comments / toolbar / workflow-panel | ✅(exist) 🔶(conform) | all block files exist; **sub-table 合计页脚** + timeline inner content need conformance golden |
