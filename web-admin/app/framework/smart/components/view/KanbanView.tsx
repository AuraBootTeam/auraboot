...
import { SmartKanban } from '~/framework/smart/components/kanban/SmartKanban';
import type { ViewConfig } from '~/framework/smart/types/savedView';
import type { KanbanDataSource, KanbanCard, KanbanCardMoveEvent } from '~/framework/smart/types/kanban';
