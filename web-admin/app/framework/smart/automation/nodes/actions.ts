...
export const actionNodes: FlowNodeDefinition[] = [
    ...
    configSchema: [
      {
        ...
        type: 'expression',
        required: true,
        placeholder: 'automation.record.updated',
        description: '$i18n:automation.field.webhookEventType.desc',
        group: 'target',
      },
      {
        key: 'url',
  ...
  },
  {
    ...
    configSchema: [
      {
        key: 'target',
        label: '$i18n:automation.field.actionTarget',
        type: 'expression',
        required: true,
        placeholder: '${record.mobile}',
        description: '$i18n:automation.field.actionTarget.desc',
        group: 'notification',
      },
      {
        key: 'template',
        label: '$i18n:automation.field.smsTemplate',
        type: 'text',
        placeholder: 'leave_timeout_notice',
        description: '$i18n:automation.field.smsTemplate.desc',
        group: 'notification',
      },
      {
        key: 'content',
        label: '$i18n:automation.field.smsContent',
        type: 'textarea',
        required: true,
        placeholder: '您的请假审批即将超时，请及时处理。',
        group: 'notification',
      },
    ],
    defaultConfig: {
  ...
  {
    type: 'action-send-im',
    label: '$i18n:automation.action.sendIm',
    icon: 'MessagesSquare',
    category: 'action',
    description: '$i18n:automation.action.sendIm.desc',
    configSchema: [
      {
        key: 'target',
        label: '$i18n:automation.field.actionTarget',
      ...
      {
        key: 'channel',
        label: '$i18n:automation.field.imChannel',
        type: 'text',
        placeholder: 'dingtalk',
        description: '$i18n:automation.field.imChannel.desc',
        group: 'notification',
      },
      {
        key: 'content',
        label: '$i18n:automation.field.imContent',
        type: 'textarea',
        required: true,
        placeholder: '请关注这条自动化提醒。',
        group: 'notification',
      },
    ],
    defaultConfig: {
  ...
  },
  {
    ...
    label: '$i18n:automation.action.createTask',
    icon: 'ListTodo',
    category: 'action',
    description: '$i18n:automation.action.createTask.desc',
    configSchema: [
      {
        key: 'target',
        label: '$i18n:automation.field.actionTarget',
        type: 'expression',
        placeholder: '${record.pid}',
        description: '$i18n:automation.field.actionTarget.desc',
        group: 'target',
      },
      {
        key: 'title',
        label: '$i18n:automation.field.taskTitle',
        type: 'expression',
        required: true,
        placeholder: '处理 ${record.wd_req_no}',
        group: 'target',
      },
      {
        key: 'assignee',
        label: '$i18n:automation.field.taskAssignee',
        type: 'expression',
        required: true,
        placeholder: 'ROLE:wd_manager',
        description: '$i18n:automation.field.taskAssignee.desc',
        group: 'target',
      },
      {
        key: 'dueDate',
        label: '$i18n:automation.field.taskDueDate',
        type: 'expression',
        placeholder: '${sla.deadlineAt}',
        group: 'advanced',
      },
    ],
    defaultConfig: {
  ...
  {
    type: 'action-cc-task',
    label: '$i18n:automation.action.ccTask',
    icon: 'UserPlus',
    category: 'action',
    description: '$i18n:automation.action.ccTask.desc',
    configSchema: [
      {
        key: 'target',
        label: '$i18n:automation.field.actionTarget',
        type: 'expression',
        required: true,
        placeholder: 'ROLE:wd_hr',
        description: '$i18n:automation.field.actionTarget.desc',
        group: 'target',
      },
      {
        key: 'taskId',
        label: '$i18n:automation.field.taskId',
        type: 'expression',
        placeholder: '${task.id}',
        group: 'target',
      },
      {
        key: 'message',
        label: '$i18n:automation.field.ccMessage',
        type: 'textarea',
        placeholder: '请同步关注该任务。',
        group: 'notification',
      },
    ],
    defaultConfig: {
  ...
  },
  {
    ...
    label: '$i18n:automation.action.addComment',
    icon: 'MessageCirclePlus',
    category: 'action',
    description: '$i18n:automation.action.addComment.desc',
    configSchema: [
      {
        key: 'content',
        label: '$i18n:automation.field.commentContent',
        type: 'textarea',
        required: true,
        placeholder: '自动化已命中，请跟进处理。',
        group: 'notification',
      },
      {
        key: 'mentions',
        label: '$i18n:automation.field.commentMentions',
        type: 'expression',
        placeholder: 'ROLE:wd_manager',
        group: 'notification',
      },
  ...
  {
    type: 'action-patch-record',
    label: '$i18n:automation.action.patchRecord',
    icon: 'FilePenLine',
    category: 'action',
    description: '$i18n:automation.action.patchRecord.desc',
    configSchema: [
      {
        key: 'modelCode',
        label: '$i18n:automation.field.modelCode',
      ...
      {
        key: 'fields',
        label: '$i18n:automation.field.patchFields',
        type: 'json',
        required: true,
        placeholder: '{ "status": "follow_up" }',
        description: '$i18n:automation.field.updateFields.desc',
        dependsOn: { field: 'modelCode' },
        group: 'fields_mapping',
      },
  ...
  {
    type: 'action-write-audit',
    label: '$i18n:automation.action.writeAudit',
    icon: 'ClipboardCheck',
    category: 'action',
    description: '$i18n:automation.action.writeAudit.desc',
    configSchema: [
      {
        key: 'message',
        label: '$i18n:automation.field.auditMessage',
        type: 'textarea',
        placeholder: '自动化命中并执行动作。',
        group: 'advanced',
      },
      {
        key: 'payload',
        label: '$i18n:automation.field.auditPayload',
        type: 'json',
        placeholder: '{ "source": "automation" }',
        group: 'advanced',
      },
    ],
    defaultConfig: {
