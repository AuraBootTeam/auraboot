...
export const actionNodes: FlowNodeDefinition[] = [
  {
    ...
    configSchema: [
      ...
      {
        key: 'recordPid',
        label: '$i18n:automation.field.recordPid',
        type: 'expression',
        required: true,
        placeholder: '${trigger.recordPid}',
        description: '$i18n:automation.field.recordPid.desc',
  ...
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'json',
        placeholder: '{ "recordPid": "${trigger.recordPid}" }',
