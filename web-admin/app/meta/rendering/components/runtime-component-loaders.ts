...
import { COMPONENT_RUNTIME_MANIFEST } from '~/meta/registry/components/ComponentRuntimeManifest';
import type { ComponentRuntimeConfig } from '~/meta/registry/components/ComponentConfig';
