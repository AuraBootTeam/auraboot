...
import { useProfileSafe } from '~/meta/profiles/ProfileContext';
import { BlockErrorBoundary } from '~/meta/rendering/BlockErrorBoundary';
...
async function loadFallbackRenderers(): Promise<Map<string, React.ComponentType<any>>> {
  ...
  const [
    ...
    import('~/meta/rendering/blocks/FormBlockRenderer'),
    import('~/meta/rendering/blocks/FormSectionBlockRenderer'),
    import('~/meta/rendering/blocks/FormButtonsBlockRenderer'),
    import('~/meta/rendering/blocks/FormWizardBlockRenderer'),
    import('~/meta/rendering/blocks/TableBlockRenderer'),
    import('~/meta/rendering/blocks/FiltersBlockRenderer'),
    import('~/meta/rendering/blocks/ToolbarBlockRenderer'),
    import('~/meta/rendering/blocks/DescriptionBlockRenderer'),
    import('~/meta/rendering/blocks/ChartBlockRenderer'),
    import('~/meta/rendering/blocks/TabsBlockRenderer'),
    import('~/meta/rendering/blocks/ApprovalCommentsBlock'),
  ]);
