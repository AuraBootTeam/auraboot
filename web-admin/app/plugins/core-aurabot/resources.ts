...
export const RESOURCES: PluginResource[] = [
  ...
  },
  {
    ...
    menu: false, parentKey: 'aurabot.traces',
  ...
  },
  {
    ...
    menu: false, parentKey: 'aurabot.knowledge',
