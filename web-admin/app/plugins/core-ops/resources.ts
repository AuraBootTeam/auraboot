...
export const RESOURCES: PluginResource[] = [
  {
    ...
    menu: { order: 10, group: 'ops' }, permission: 'notification.read',
  ...
  },
  {
    ...
    menu: { order: 20, group: 'ops' }, permission: 'notification.read',
  ...
  },
  {
    ...
    menu: { order: 30, group: 'ops' }, permission: 'scheduler.read',
  ...
  },
  {
    ...
    menu: { order: 50, group: 'ops' }, permission: 'documents.use',
