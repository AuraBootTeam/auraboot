...
import type { ActionConfig, ActionPhaseType } from '~/plugins/core-designer/components/studio/workbench/panels/actions/types';
    ...
    <>
      ...
      <div>
        <LocalizedTextInput
          ...
          placeholder="覆盖默认文案"
          disabled={readonly}
          testId={`button-label-${button.code ?? (typeof button.action === 'string' ? button.action : 'custom')}`}
        />
      </div>
