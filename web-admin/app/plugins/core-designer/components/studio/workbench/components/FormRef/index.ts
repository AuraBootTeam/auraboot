...
} from '~/plugins/core-designer/components/studio/workbench/components/FormRef/FormRefManager';

// React 组件
export { FormRef } from '~/plugins/core-designer/components/studio/workbench/components/FormRef/FormRef';
export { FormFieldRenderer } from '~/plugins/core-designer/components/studio/workbench/components/FormRef/FormFieldRenderer';
