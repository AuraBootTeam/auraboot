...
import { useCrossColumnDrag } from '~/plugins/core-designer/components/studio/hooks/drag/useCrossColumnDrag';
import type { ResizeTarget } from '~/plugins/core-designer/components/studio/services/layout/resize/CrossColumnDragEngine';
