...
export const RESOURCES: PluginResource[] = [
  {
    ...
    menu: { order: 10, group: 'ai' }, permission: 'ai.settings.read',
  ...
  },
  {
    ...
    menu: { order: 20, group: 'ai' }, permission: 'ai.agent.read',
  ...
  },
  {
    ...
    menu: false, parentKey: 'ai.colleagues', permission: 'ai.agent.create',
