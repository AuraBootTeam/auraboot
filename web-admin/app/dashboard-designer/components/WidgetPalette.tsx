  ...
  return (
    ...
    >
      <div className="border-b border-gray-200 p-4">
        <h2 className="text-sm font-semibold text-gray-700">{resolveDesignerText(DESIGNER_I18N.palette.title, locale)}</h2>
        <p className="mt-1 text-xs text-gray-500">{resolveDesignerText(DESIGNER_I18N.palette.dragHint, locale)}</p>
      </div>
