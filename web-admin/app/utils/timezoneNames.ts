...
export const TIMEZONE_ENTRIES: TimezoneEntry[] = [
  // China
  {
    ...
    displayName: '北京/上海',
    utcOffset: 'UTC+8',
    searchTerms: ['北京', '上海', '重庆', '乌鲁木齐', 'Beijing', 'Shanghai', 'Chongqing', 'China', 'cst'],
  },
  {
    iana: 'Asia/Hong_Kong',
    displayName: '香港',
  ...
  // Thailand / Vietnam
  {
    ...
    displayName: '曼谷/河内',
    utcOffset: 'UTC+7',
    searchTerms: ['曼谷', '河内', '胡志明', 'Bangkok', 'Hanoi', 'Ho Chi Minh', 'Thailand', 'Vietnam', 'ict'],
  },
  // Indonesia
  {
    iana: 'Asia/Jakarta',
  ...
  },
  {
    ...
    displayName: '巴黎/柏林',
    utcOffset: 'UTC+1',
    searchTerms: ['巴黎', '柏林', '罗马', '马德里', 'Paris', 'Berlin', 'Rome', 'Madrid', 'cet', 'cest'],
  },
  {
  ...
  // USA & Canada
  {
    ...
    displayName: '纽约',
    utcOffset: 'UTC-5',
    searchTerms: ['纽约', '波士顿', '迈阿密', '华盛顿', 'New York', 'Boston', 'Miami', 'Washington', 'DC', 'est', 'edt', 'Eastern'],
  },
  {
    iana: 'America/Chicago',
    displayName: '芝加哥',
    utcOffset: 'UTC-6',
    searchTerms: ['芝加哥', '休斯顿', '达拉斯', 'Chicago', 'Houston', 'Dallas', 'cst', 'cdt', 'Central'],
  },
  {
    iana: 'America/Denver',
    displayName: '丹佛',
  ...
  },
  {
    ...
    displayName: '洛杉矶',
    utcOffset: 'UTC-8',
    searchTerms: ['洛杉矶', '旧金山', '西雅图', '拉斯维加斯', 'Los Angeles', 'San Francisco', 'Seattle', 'Las Vegas', 'pst', 'pdt', 'Pacific'],
  },
  {
  ...
  },
  {
    ...
    displayName: '悉尼',
    utcOffset: 'UTC+10',
    searchTerms: ['悉尼', '墨尔本', '堪培拉', 'Sydney', 'Melbourne', 'Canberra', 'Australia', 'aedt', 'aest'],
  },
  {
