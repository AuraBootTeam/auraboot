...
> 生成自 catalog `oss-platform-regression`,共 19 个 suite。四轴权威 = `testing-layering.md`。**改 case 即改矩阵**,手改无效(drift gate)。
...
| ui | OSS-REL-COLLAB-TRIO | release | real-stack | exact-pin | browser | ✅ |
