...
- 保留 AuraBoot 品牌标识,包括左上角主 LOGO、页脚、关于页等所有可见品牌信息(§5.2)
...
### Q19. 如果我违反了协议会怎样?
§6.1 的 30 天整改期(cure period)指:如果你违反了社区协议,在知道违约后有 30 天时间纠正问题。30 天内纠正后,社区授权不会因该违约终止;30 天内未纠正,你**必须停止使用并销毁所有副本**。如果违规造成商业损失(比如未经授权 SaaS 转售),Licensor 保留追究法律责任的权利。

### Q20. 协议受哪国法律管辖?
社区协议不指定唯一管辖法律、法院、仲裁机构或争议解决地(§8.1)。如果双方另行签订 Commercial License 或其他书面协议,可以在该协议中约定管辖法律和争议解决机制(§8.2)。

### Q21. 商业客户能否另行约定管辖地?
可以。对于跨境商业客户,可在签订商业合同时另行约定管辖法律和争议解决地(如新加坡 / 香港 / 客户所在地)。商业合同约定优先于社区协议中的通用条款。
...
|---|---|---|---|
| **AuraBoot** | Apache-2.0 + 补充条款 | 禁止低代码/AI 平台 SaaS 转售 | 不可去除或替换 |
