// CRM page tour v3b — zh-CN, slot 20 stack (vite 5120), controlled data, strict checks.
...
// API form login (establishes session cookie)
...
fs.writeFileSync(path.join(OUT, 'tour-results.json'), JSON.stringify(results, null, 2));
await browser.close();
