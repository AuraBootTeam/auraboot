#!/usr/bin/env bash
# Synchronize the plugin marketplace catalog from plugin manifests.
#
# This script intentionally does not install plugins into a tenant. It scans
# PLUGIN_DIRS for plugin.json files and projects their manifest metadata into
# the system-tenant marketplace catalog tables.
set -euo pipefail
