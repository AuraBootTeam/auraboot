...
public interface NamedQueryService {
    ...
    void authorizeExportDownload(String code, NamedQueryDataExportRequest request, com.fasterxml.jackson.databind.JsonNode definitionSnapshot, String rowSetDigest);
}
