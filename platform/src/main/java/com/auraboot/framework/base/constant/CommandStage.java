 ...
 * Each constant represents a sequential phase in the service orchestration layer.
 *
 ...
 *
 * @see com.auraboot.framework.base.annotation.CommandPhase
 */
public final class CommandStage {
    ...
    /** Stage 7: Assert — evaluate preconditions, assertions, and field validation rules. */
    ...
    public static String descriptionOf(int stage) {
        return switch (stage) {
            ...
            case CONSISTENCY_CHECK -> "Cross-document constraint validation";
