...
public class AuthoringGovernanceValidator {
    ...
    public void requireFresh(GovernanceRow row) {
        ...
        AuthoringActiveReleaseResolver.ActiveRelease active = activeReleaseResolver.findByResource(
    ...
    public void requirePublishable(GovernanceRow row) {
        if (!"VALID".equals(row.validationState()) || !"READY".equals(row.publishState())) {
