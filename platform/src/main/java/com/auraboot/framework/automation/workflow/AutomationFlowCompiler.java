 ...
 *       {@link AutomationActionAccessorImpl} (action config travels via the
...
public class AutomationFlowCompiler {
    ...
    public CompiledFlow compile(Automation automation) {
        ...
        // executor), so the body serviceTask iterates inside AutomationActionAccessorImpl
        ...
        for (Map<String, Object> node : nodes) {
            ...
            if (type.startsWith("trigger")) {
                ...
                od.putObject("config").put("className", AutomationActionAccessor.DELEGATE_BEAN_NAME);
     ...
     *
     * <p>The descriptor is honored at runtime by {@link AutomationActionAccessorImpl}
