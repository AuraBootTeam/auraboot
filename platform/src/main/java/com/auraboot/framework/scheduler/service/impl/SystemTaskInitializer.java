...
public class SystemTaskInitializer {
    ...
    private static final List<TaskDef> SYSTEM_TASKS = List.of(
            ...
            new TaskDef("sys-rag-embedding-retry", "RAG Embedding Retry",
                    "interval", null, 300000L,
                    "embeddingRetryService", "retryFailedChunks",
                    "Retries failed chunk embeddings with bounded attempts (max 5, then failed_permanent)"),
