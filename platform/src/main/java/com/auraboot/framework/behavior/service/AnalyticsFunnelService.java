...
public class AnalyticsFunnelService {
    ...
    public AnalyticsFunnel query(Long tenantId, BehaviorQueryWindow window, Instant cutoff) {
        ...
        String[] codes = {"requested", "query_succeeded", "result_viewed", "dashboard_saved", "dashboard_used"};
        ...
        return new AnalyticsFunnel("analysis-task-funnel-v1", "analysis_task", "initiator_first_entry_in_window",
