...
public class FieldAddSkill implements AuraBotSkill {
    ...
    public SkillResult dryRun(SkillRequest req) {
        // T7 lands real impl — preview surfaces NEEDS_CONFIRM with summary
        // payload after model lookup + storageCode conflict check. Stub
        // throws so the unit test for "unknown model → PARAMS_INVALID" stays
        // RED until T7 wires the implementation.
        throw new UnsupportedOperationException(name() + " dryRun not implemented yet");
    }
