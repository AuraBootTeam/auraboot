...
public interface FileRelationMapper extends BaseMapper<FileRelationEntity> {
    ...
    List<Long> findFileIdsByEntity(@Param("entityType") String entityType, @Param("entityId") String entityId);
    ...
    List<Long> findFileIdsByEntityAndField(@Param("entityType") String entityType, @Param("entityId") String entityId, @Param("fieldName") String fieldName);
