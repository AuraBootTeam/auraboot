...
-- Source: V20260618000000__baseline_core_schema.sql
-- AuraBoot core-only migration
-- Generated by scripts/application/migration-ownership.mjs.
-- Do not edit this staged artifact; edit the owning source migration/config instead.
-- Source: V20260618000000__baseline_core_schema.sql
...
CREATE TABLE IF NOT EXISTS ab_automation (
    ...
    CONSTRAINT chk_automation_trigger_type CHECK (trigger_type IN (
        ...
        'on_state_change', 'scheduled', 'webhook', 'on_workflow_event', 'on_inactivity'
    ))
);
...
CREATE TABLE IF NOT EXISTS ab_agent_definition (
  ...
  allowed_models     JSONB,                          -- Model codes this agent can access: ["sales_order","customer_account"], "*" = all
...
ALTER TABLE ab_agent_approval
    ...
    ADD COLUMN IF NOT EXISTS revalidate_policy VARCHAR(20) DEFAULT 'none';

-- none | data_freshness | full_revalidate
...
ALTER TABLE ab_agent_action
    ...
    ADD COLUMN IF NOT EXISTS risk_deviation BOOLEAN DEFAULT FALSE;

-- true if actual_risk > estimated_risk
