...
@org.mybatis.spring.annotation.MapperScan({"com.auraboot.framework.*.mapper", "com.auraboot.framework.*.dao.mapper", "com.auraboot.framework.*.dao", "com.auraboot.framework.aurabot.skill.mapper", "com.auraboot.framework.chatbi.v2.mapper", "com.auraboot.framework.connector.saas.oauth", "com.auraboot.framework.saas.config.mapper", "com.auraboot.framework.saas.account.mapper", "com.auraboot.framework.saas.license.mapper", "com.auraboot.smart.framework.engine.persister.database"})
