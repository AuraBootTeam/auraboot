...
public interface RecordShareAccessor {
    ...
    /**
     * Replace direct member collaboration grants for a record.
     *
     * <p>The default preserves binary compatibility for older hosts. Hosts that support
     * collaboration masks override this method and persist {@code read,update}.</p>
     */
