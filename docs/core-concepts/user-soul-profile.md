...
**Plan**: historical 2026-04-19 design, consolidated into this subsystem reference.
**Follow-up design**: Memory L1→L2 promotion, consolidated into [Memory Tier Promotion](./memory-tier-promotion.md).
