...
**Design**: historical plan archived outside this docs tree; this subsystem reference is the canonical maintained entry.
...
- 设计与 Phase checklist：历史计划已归档到当前 docs tree 外；本文 §9.1/§9.1a/§9.2 反映已交付状态。
