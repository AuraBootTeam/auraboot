...
> - ⏳ 0.5 step-5 harness smoke: the one remaining Phase-0 item — drive the real designer (drag one node) against the up stack to prove the harness + testids + HTML5-drag work end-to-end (§20 guard).
