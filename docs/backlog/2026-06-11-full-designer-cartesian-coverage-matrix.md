...
3. Dashboard / Report Designer：Dashboard tab persistence、management row action/list tab lifecycle、Dashboard Excel/PDF artifact、Report table + non-table static Excel/PDF artifact 已完成;下一轮集中补 registry workbench widgets、widget payload/property precision、Report model/namedQuery/API dataSource artifact 证据。
