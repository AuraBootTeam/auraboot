...
| dashboard | smart-progress | title, target, format, shape | P1: property panel + render | DONE(saved-payload): 2026-06-12 `DW-052` proves UI click-add, static dataSource edit, representative `visualization.shape` property edit, Save API, `/api/dashboards/{pid}` readback, exact `type/componentType`, default `进度` title, and default size. Runtime render still tracked separately. |
...
| dashboard | smart-leaderboard | title, maxItems, rankField, valueField | P1: property panel + render | DONE(saved-payload): 2026-06-12 `DW-056` proves UI click-add, static dataSource edit, representative `visualization.maxItems` property edit, Save API, `/api/dashboards/{pid}` readback, exact `type/componentType`, and default size. Runtime render still tracked separately. |
| dashboard | smart-rich-text | title, content, format | P1: property panel + render | DONE(saved-payload): 2026-06-12 `DW-057` proves UI click-add, static dataSource edit, representative `visualization.content` property edit, Save API, `/api/dashboards/{pid}` readback, exact `type/componentType`, click-add label title fallback, and default size. Runtime render still tracked separately. |
| dashboard | smart-image | title, src, alt, objectFit | P1: property panel + render | DONE(saved-payload): 2026-06-12 `DW-058` proves UI click-add, static dataSource edit, representative `visualization.src` property edit, Save API, `/api/dashboards/{pid}` readback, exact `type/componentType`, click-add label title fallback, and default size. Runtime render still tracked separately. |
| dashboard | smart-iframe | title, src | P1: property panel + render | DONE(saved-payload): 2026-06-12 `DW-059` proves UI click-add, static dataSource edit, representative `visualization.src` property edit, Save API, `/api/dashboards/{pid}` readback, exact `type/componentType`, click-add label title fallback, and default size. Runtime render still tracked separately. |
| dashboard | smart-countdown | title, targetDate, format | P1: property panel + render | DONE(saved-payload): 2026-06-12 `DW-060` proves UI click-add, static dataSource edit, representative `visualization.targetDate` property edit, Save API, `/api/dashboards/{pid}` readback, exact `type/componentType`, and default size. Runtime render still tracked separately. |
...
| dashboard | smart-stats-row | title | P1: workbench widget render | DONE(saved-payload): 2026-06-12 `DW-061` proves UI click-add, static dataSource edit, title edit, Save API, `/api/dashboards/{pid}` readback, exact `type/componentType`, and default size. Workbench runtime render still tracked separately. |
