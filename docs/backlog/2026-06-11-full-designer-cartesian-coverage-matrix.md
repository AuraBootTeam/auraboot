...
3. Dashboard Designer：tab persistence 与 management row action/list tab lifecycle 已完成;下一轮集中补 registry workbench widgets、widget payload/property precision、以及 dashboard/report artifact 深度差异。
