...
- 37 个 widget 现在已有 representative saved-payload / property value matrix;仍未覆盖每个 widget 的全部 `configSchema` 字段,也不能外推为 exhaustive property matrix DONE。
